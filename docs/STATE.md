...
- What’s working end-to-end:
  ...
  - Extension popup (`inspector.html`) supports session selection, shows selected session steps, provides start/stop controls, exports selected session JSON, and can clear selected/all capture data.
...
- Next micro-task (1 line): add basic step categorization labels in popup (click vs key) for faster scan.
