...
Historical snapshot notice: this prompt targets the March 2026 audit-pack baseline and is not a current source-of-truth brief. Reconcile with `docs/STATE.md`, `docs/team-library-protocol.md`, and current repo code before reuse.
...
Use this prompt with GPT and provide the full `docs/archive/audit-pack/` folder plus referenced source files.

## Prompt

You are auditing a Chrome MV3 extension + React app called Cap Me Action.

Read all docs in `docs/archive/audit-pack/` and treat them as a March 2026 implementation baseline, not as current source of truth.  
