...
- What’s working end-to-end:
  ...
  - Extension popup (`inspector.html`) shows latest session and recent steps in extension context.
...
- Next micro-task (1 line): add explicit capture controls (start/stop) and ignore clicks when not capturing.
